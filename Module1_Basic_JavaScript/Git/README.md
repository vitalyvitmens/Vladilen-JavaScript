...
6. git reset [hash_commit] --soft - откат назад к коммиту с хэшом [hash_commit] указанным в команде без потери изменений в Staged Changes с возможностью переложить изменения в другие коммиты
