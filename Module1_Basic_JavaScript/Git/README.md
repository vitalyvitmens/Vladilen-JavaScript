...
5. git format-patch [hash_commita] - данная команда более автоматизированная, она кроме того что делается в пункте 1. передает еще и коммиты
