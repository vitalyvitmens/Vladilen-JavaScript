...
15. git checkout -b [new-name-branch-3] - создаем новую третью ветку [new-name-branch-3] которая будет указывать на один и тот же коммит, что и ветка [new-name-branch-2]
