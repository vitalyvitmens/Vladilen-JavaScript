...
НЕ ЗАБЫВАЙТЕ в случае работы с одной веткой использовать интерактивный режим -i ребэйса: git rebase [hash_commit] -i
